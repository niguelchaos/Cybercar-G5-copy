...
#ifndef STOPCARREQUEST_HPP
#define STOPCARREQUEST_HPP
...
using namespace std::string_literals; // NOLINT
class LIB_API StopCarRequest {
    private:
        static constexpr const char* TheShortName = "StopCarRequest";
        static constexpr const char* TheLongName = "StopCarRequest";
    ...
    public:
        StopCarRequest() = default;
        StopCarRequest(const StopCarRequest&) = default;
        StopCarRequest& operator=(const StopCarRequest&) = default;
        StopCarRequest(StopCarRequest&&) = default;
        StopCarRequest& operator=(StopCarRequest&&) = default;
        ~StopCarRequest() = default;
...
template<>
struct isVisitable<StopCarRequest> {
    static const bool value = true;
};
template<>
struct isTripletForwardVisitable<StopCarRequest> {
    static const bool value = true;
};
#endif
